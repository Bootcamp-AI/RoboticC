#include "ros/ros.h"
#include "bai_cpp_pkg/OddEvenCheck.h"
...
int main(int argc, char **argv)
{
  ...
  ros::ServiceClient client = node_handle.serviceClient<bai_cpp_pkg::OddEvenCheck>("odd_even_check");

  bai_cpp_pkg::OddEvenCheck odd_even_check_srv;
