#include "ros/ros.h"
#include "bai_cpp_pkg/TurnCamera.h"
...
bool getCameraImage(bai_cpp_pkg::TurnCamera::Request &req,
                      bai_cpp_pkg::TurnCamera::Response &res)
{
  ...
  image_path = ws_dir + "src/bai_cpp_pkg/images/" + std::to_string((int)closest_num) + ".png";
