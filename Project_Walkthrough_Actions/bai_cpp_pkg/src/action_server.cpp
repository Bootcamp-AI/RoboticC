...
typedef actionlib::SimpleActionServer<bai_cpp_pkg::Navigate2DAction> NavServer;

float DIST_THRESHOLD = 0.1;
geometry_msgs::Point robot_current_position;

void navCallback(const bai_cpp_pkg::Navigate2DGoal::ConstPtr& goal_point,
                 NavServer* nav_server)
{
  bai_cpp_pkg::Navigate2DFeedback feedback_msg;
  bai_cpp_pkg::Navigate2DResult result_msg;
