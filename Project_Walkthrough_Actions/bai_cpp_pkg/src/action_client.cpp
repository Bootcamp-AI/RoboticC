...
#include "bai_cpp_pkg/Navigate2DAction.h"

typedef actionlib::SimpleActionClient<bai_cpp_pkg::Navigate2DAction> NavClient;
...
void feedbackCallback(const bai_cpp_pkg::Navigate2DFeedback::ConstPtr& feedback)
{
...
void resultCallback(const actionlib::SimpleClientGoalState& state,
                    const bai_cpp_pkg::Navigate2DResult::ConstPtr& result)
{
...
int main(int argc, char **argv)
{
  ...
  bai_cpp_pkg::Navigate2DGoal goal;
  goal.point.z = 0;
